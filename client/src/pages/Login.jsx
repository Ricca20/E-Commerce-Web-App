            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-zinc-100">
                ...
                <div className="p-12 flex flex-col justify-center">
                    <div className="mb-8">
                        ...
                        <p className="text-zinc-500">Enter your details below.</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-black text-white py-4 rounded-lg text-sm font-bold uppercase hover:bg-zinc-800 transition-all transform active:scale-[0.98] disabled:opacity-50"
                        >
                    ...
                    <p className="text-center text-sm text-zinc-500 mt-8">
                        New here?{' '}
                        <Link to="/register" className="text-black font-bold hover:underline">Create an account</Link>
                    </p>
                </div>
            </div>
        </div>
